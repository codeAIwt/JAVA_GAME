...
public class GameWorld {
	...
	Image bImage;     //游戏场景背景图
	Image fImage;     //游戏场景前景图
	
	AudioClip bgm;    //游戏背景音乐    
	//所有的动画信息对象
	ArrayList<AnimPara> allAnimParas = new ArrayList<AnimPara>();
	//所有的音效信息对象
	ArrayList<SoundPara> allSoundParas = new ArrayList<SoundPara>();	
	//所有的弹药参数对象
	ArrayList<AmmoPara> allAmmoParas = new ArrayList<AmmoPara>();	
	...
	void initAllGameObjects(){
		...
		this.addGameObject(new  Collision(this,new Point2D(60,840),new Point2D(200,100),"picture_2.png"));
		...
		this.addGameObject(new  Collision(this,new Point2D(320,510),new Point2D(100,100),"picture_2.png"));
		this.addGameObject(new  Collision(this,new Point2D(290,520),new Point2D(100,80),"picture_2.png"));
		this.addGameObject(new  Collision(this,new Point2D(380,1030),new Point2D(100,80),"picture_2.png"));
		this.addGameObject(new  Collision(this,new Point2D(450,1000),new Point2D(60,50),"picture_2.png"));
    	...
    	this.addGameObject(new  Collision(this,new Point2D(750,1200),new Point2D(100,100),"picture_2.png"));
    	this.addGameObject(new Collision(this,new Point2D(930,1200),new Point2D(60,60),"picture_2.png"));
    	...
    	this.addGameObject(new  Collision(this,new Point2D(1450,480),new Point2D(400,400),"picture_2.png"));
    	this.addGameObject(new  Collision(this,new Point2D(1470,750),new Point2D(100,100),"picture_2.png"));
    	...
    	this.addGameObject(new  Collision(this,new Point2D(330,120),new Point2D(100,80),"picture_2.png"));
